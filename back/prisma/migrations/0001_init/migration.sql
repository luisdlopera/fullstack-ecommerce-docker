...
-- CreateEnum
CREATE TYPE "Role" AS ENUM ('SUPER_ADMIN', 'ADMIN', 'MANAGER', 'SUPPORT', 'USER');
...
CREATE TABLE "Country" (
    ...
    "allowsPurchase" BOOLEAN NOT NULL DEFAULT true,
    "shippingBaseCost" DOUBLE PRECISION NOT NULL DEFAULT 0,
