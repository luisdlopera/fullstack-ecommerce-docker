...
-- CreateEnum
CREATE TYPE "InventoryMovementType" AS ENUM ('IN', 'OUT', 'ADJUSTMENT', 'TRANSFER', 'RESERVE', 'RELEASE', 'COMMIT');
...
-- CreateIndex
CREATE UNIQUE INDEX "Order_guestCheckoutToken_key" ON "Order"("guestCheckoutToken");
