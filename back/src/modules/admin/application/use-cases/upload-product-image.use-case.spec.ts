...
describe('UploadProductImageUseCase', () => {
  ...
  it('uploads image and persists metadata through repository', async () => {
    ...
    storage.getPublicUrl.mockReturnValue('http://localhost:9000/nexstore-products/products/p1/a.jpg');
    repository.createProductImage.mockResolvedValue({
      id: 10,
      productId: 'p1',
      url: 'http://localhost:9000/nexstore-products/products/p1/a.jpg',
