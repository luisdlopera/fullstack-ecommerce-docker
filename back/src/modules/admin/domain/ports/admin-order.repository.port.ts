...
export interface AdminOrderRepositoryPort {
  ...
  updateStatus(orderId: string, data: { status: OrderStatus; isPaid?: boolean; paidAt?: Date; paymentStatus?: PaymentStatus }): Promise<unknown>;
  updatePaymentStatus(orderId: string, data: { paymentStatus: PaymentStatus; isPaid?: boolean; paidAt?: Date }): Promise<unknown>;
