	...
	return (
		...
		>
			<div className='min-h-0 flex-1'>
				...
				<h1 className='mt-1 text-2xl leading-tight font-semibold tracking-tight text-neutral-900 md:text-3xl'>
					{product.name}
				</h1>
				<p className='mt-2 text-2xl font-medium text-neutral-900 tabular-nums md:text-3xl'>
