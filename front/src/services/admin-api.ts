...
export const dashboardApi = {
  getSummary: (period?: string) =>
    adminFetch<DashboardSummary>(`/admin/dashboard/summary${buildQuery({ period })}`),
...
export const usersApi = {
  ...
  delete: (id: string) =>
    adminFetch<{ ok: boolean }>(`/admin/users/${id}`, { method: 'DELETE' })
};

// ─── Orders ──────────────────────────────────────────────────────────

export const ordersApi = {
  list: (params: { page?: number; limit?: number; search?: string; status?: string; paymentStatus?: string; paid?: boolean }) =>
  ...
  updatePaymentStatus: (id: string, paymentStatus: string) =>
    adminFetch<AdminOrder>(`/admin/orders/${id}/payment-status`, { method: 'PATCH', body: JSON.stringify({ paymentStatus }) }),

  updateNotes: (id: string, internalNotes: string) =>
    adminFetch<AdminOrder>(`/admin/orders/${id}/notes`, { method: 'PATCH', body: JSON.stringify({ internalNotes }) })
};

// ─── Products ────────────────────────────────────────────────────────

export const productsApi = {
  list: (params: { page?: number; limit?: number; search?: string; categoryId?: string; isActive?: boolean; inStock?: boolean }) =>
  ...
  updateStatus: (id: string, isActive: boolean) =>
    adminFetch<AdminProduct>(`/admin/products/${id}/status`, { method: 'PATCH', body: JSON.stringify({ isActive }) }),

  addImage: (id: string, imageUrl: string) =>
    adminFetch<{ id: number; url: string }>(`/admin/products/${id}/images`, { method: 'POST', body: JSON.stringify({ imageUrl }) }),
...
export const categoriesApi = {
  ...
  delete: (id: string) =>
    adminFetch<{ ok: boolean }>(`/admin/categories/${id}`, { method: 'DELETE' })
};
...
export const countriesApi = {
  list: () =>
    adminFetch<AdminCountry[]>('/admin/countries'),
  ...
  delete: (id: string) =>
    adminFetch<{ ok: boolean }>(`/admin/countries/${id}`, { method: 'DELETE' })
};
